...
class PaymentTest {
    ...
    @Test
    @DisplayName("create는 status=PENDING, externalPaymentKey=null로 생성한다")
    void create_initializes_pending_with_null_external_key() {
        Payment payment = Payment.create(10L, "idem-1");
    ...
    void create_rejects_null_enrollment_id() {
        assertThatThrownBy(() -> Payment.create(null, "idem-1"))
    ...
    void create_rejects_blank_idempotency_key(String key) {
        assertThatThrownBy(() -> Payment.create(10L, key))
                .isInstanceOf(IllegalArgumentException.class);
    }
    ...
    void create_rejects_null_idempotency_key() {
        assertThatThrownBy(() -> Payment.create(10L, null))
                .isInstanceOf(IllegalArgumentException.class);
    }
