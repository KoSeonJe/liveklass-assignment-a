...
public class Payment {
    ...
    private Payment(Long enrollmentId, String idempotencyKey) {
        this.enrollmentId = enrollmentId;
        this.idempotencyKey = idempotencyKey;
        this.status = PaymentStatus.PENDING;
    }

    public static Payment create(Long enrollmentId, String idempotencyKey) {
        ...
        return new Payment(enrollmentId, idempotencyKey);
    }
